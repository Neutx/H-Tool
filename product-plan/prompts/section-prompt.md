...
- **SECTION_NAME** = [Human-readable name, e.g., "Cancellation Rules Engine" or "Refund Management"]
- **SECTION_ID** = [Folder name in sections/, e.g., "cancellation-rules-engine" or "refund-management"]
