...
import type { ReasonCategory, CustomerOrder, CancellationRequestData } from "@/lib/customer-portal-types";

interface CancellationRequestFormProps {
  order: CustomerOrder;
  onSubmit: (data: CancellationRequestData) => Promise<{ success: boolean; error?: string }>;
  onSuccess: () => void;
  onCancel: () => void;
}
